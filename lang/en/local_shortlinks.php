...
$string['shortlink:delete:content'] = 'Are you sure you want to delete this link? Once deleted the short link will no longer work.';
$string['shortlink:delete:title'] = 'Delete link?';
$string['shortlink:delete:yes'] = 'Delete';
$string['shortlink:deleted'] = 'Short link has been deleted successfully';
